...
A $10,000 report Proton has not paid me for.
...
When the engineering & security of Proton take into consideration the factor of severity: The severity of my report and how it may impact the scope, confidentiality, integrity, or availability of our services.
...
Still, the impact of availability again is quite possibly maximum severity of fully unavailable Proton services yet unlikely an attacker would deny service to the user when the attacker can do covert yeavsdropping and even impersonate Proton in the process. Having potentially maximum severity about service availability, yet still.  
 ...
 The quality of my report: Proton prefer's proof of concepts that include code or pseudocode that clearly demonstrate the vulnerability being reported: however no code is necesarry to create a spoof certificate. Although I did link to my code repository https://github.com/freedom-foundation/CA which provide's a solution or fix and I did write a PoC.
